...
\hypersetup{
  ...
  pdftitle={Control of a pan/tilt system},    % title
  ...
  pdfsubject={Control system design and  implementation},   % subject of the document
  pdfkeywords={Control system} {pan} {tilt} {University of Southern Denmark} {SDU}, % list of keywords
